...
function App() {
  ...
  const conditions = useMemo(
    () => [
      { id: 'celiac', name: '乳糜瀉（Celiac disease）', match: ['gi','fatigue','weight','sleep'], prevalenceP: 0.007, cureRateP: 0.7, severeAnnualRiskP: 0, shortDesc: '麩質引發的小腸免疫性損傷，影響吸收、體重與多系統症狀。', longDesc: '乳糜瀉是免疫系統對「麩質」產生異常反應，吃進小麥、大麥、黑麥等穀物後，免疫攻擊會破壞小腸絨毛，造成吸收不良。輕則反覆腹瀉、腹脹、體重下降與營養缺乏；重者可能出現<strong>嚴重鐵缺乏性貧血、骨質疏鬆、電解質失衡、神經病變</strong>，長期未控制會顯著影響兒童生長與成人體力，甚至增加某些腸道惡性疾病風險。典型情境是：日常飲食看似正常，但人愈來愈虛弱、容易疲倦，餐後腹脹像被氣球撐開，肚子痛到彎腰；久而久之<strong>指甲脆裂、頭髮易斷、站起來就暈</strong>。確診仰賴血清抗體與小腸切片，治療核心是嚴格「無麩質飲食」，才可逆轉黏膜受損並降低併發症。若自覺「一吃就脹、慢性腹瀉、體重無故下降」，或合併缺鐵/骨鬆，務必就醫評估。' },
      { id: 'ms', name: '多發性硬化症（Multiple sclerosis）', match: ['headache','fatigue','sleep'], prevalenceP: 0.0025, cureRateP: 0.3, severeAnnualRiskP: 0, shortDesc: '中樞神經脫髓鞘疾病，易反覆復發與逐步進展，影響多種神經功能。', longDesc: '多發性硬化症為中樞神經（腦與脊髓）脫髓鞘疾病，症狀可忽好忽壞：視力模糊或視神經痛、手腳無力與麻木、步態不穩、熱會誘發疲勞與症狀惡化。疾病進展時，病灶宛如在中樞神經留下一道道「斷裂的訊號路」，讓精細動作、平衡、記憶與情緒都被牽動。部分患者呈「復發—緩解型」，但若控制不佳，可能逐漸走向<strong>殘疾累積（如步行需輔具）</strong>。現代治療強調早期疾病修飾治療（DMTs）以減少復發與新病灶，並搭配復健與症狀控制。任何<strong>突發單眼視力下降、身體半側麻木、走路像踩在棉花上的不穩</strong>，都該盡快就醫；急性期常需類固醇等治療，長期則視亞型與活動度選擇藥物以延緩惡化。' },
      { id: 'ra', name: '類風濕性關節炎（Rheumatoid arthritis）', match: ['neck','fatigue','sleep'], prevalenceP: 0.0046, cureRateP: 0.3, severeAnnualRiskP: 0, shortDesc: '自體免疫多關節炎，亦可累及心、肺、眼與血管。', longDesc: '類風濕性關節炎是自體免疫造成的滑膜炎，清晨僵硬與對稱性小關節腫痛最典型。未控制的慢性發炎會像「火」一樣在關節內燒，時間拉長便<strong>侵蝕軟骨與骨端，導致關節變形、力量流失</strong>；發炎介質也可波及全身，引發貧血、疲倦與心血管風險上升。嚴重時，抓握開瓶、轉門把、扣鈕扣都成挑戰，甚至夜間痛醒。治療目標是「及早緩解發炎、阻止結構破壞」：以 csDMARDs、生物製劑或標靶小分子搭配密切追蹤調整爭劑量。拖延治療會讓<strong>不可逆的結構損傷</strong>悄悄累積，因此一旦出現持續多關節腫痛、晨僵超過 30 分鐘，需及時就醫由風濕專科介入。' },
      ...
      { id: 'meniere', name: '梅尼爾氏症（Ménière’s disease）', match: ['headache','fatigue','sleep'], prevalenceP: 0.0019, cureRateP: 0.4, severeAnnualRiskP: 0, shortDesc: '內耳液體調節異常，眩暈、耳鳴與波動性聽力損失。', longDesc: '為內耳疾患，特徵是反覆且難以預測的眩暈發作，伴隨耳鳴、聽力波動與耳內悶脹感。發作來臨時，<strong>世界像被猛烈旋轉，患者需緊抓固定物、噁心嘔吐、步履蹣跚</strong>；每次可持續數分鐘到 24 小時，次數不定，長期可能導致進行性聽力損失與生活/工作中斷。治療著重減少發作頻率與控制症狀（如飲食限鹽、利尿劑、前庭復健、必要時侵入性治療）。若眩暈合併新出現的<strong>單側耳聾、神經學異常</strong>或持續不止，需排除其他急症。' },
