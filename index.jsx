...
function App() {
  ...
  const conditions = useMemo(() => [
    {
      id: 'celiac',
      name: '乳糜瀉（Coeliac disease）',
      match: ['gi','fatigue','weight','sleep'],
      prevalenceP: 0.007, cureRateP: 0.7, severeAnnualRiskP: 0,
      shortDesc: '麩質引發的小腸免疫性損傷，影響吸收、體重與多系統症狀。',
      longDescHtml:
`乳糜瀉是免疫系統對「麩質」產生異常反應，吃進小麥、大麥、黑麥等穀物後，免疫攻擊會破壞小腸絨毛，造成吸收不良。輕則反覆腹瀉、腹脹、體重下降與營養缺乏；重者可能出現嚴重鐵缺乏性貧血、骨質疏鬆、電解質失衡、神經病變，長期未控制會顯著影響兒童生長與成人體力，甚至增加某些腸道惡性疾病風險。典型情境是：日常飲食看似正常，但人愈來愈虛弱、容易疲倦，餐後腹脹像被氣球撐開，肚子痛到彎腰；久而久之<strong>指甲脆裂、頭髮易斷、站起來就暈</strong>。確診仰賴血清抗體與小腸切片，治療核心是嚴格「無麩質飲食」，才可逆轉黏膜受損並降低併發症。`
    },
    {
      id: 'ms',
      ...
      longDescHtml:
`多發性硬化症為中樞神經（腦與脊髓）脫髓鞘疾病，症狀可忽好忽壞：視力模糊或視神經痛、手腳無力與麻木、步態不穩、熱會誘發疲勞與症狀惡化。疾病進展時，病灶宛如在中樞神經留下一道道「斷裂的訊號路」，讓精細動作、平衡、記憶與情緒都被牽動。部分患者呈「復發—緩解型」，但若控制不佳，可能逐漸走向殘疾累積（如步行需輔具）。現代治療強調早期疾病修飾治療（DMTs）以減少復發與新病灶，並搭配復健與症狀控制。任何突發單眼視力下降、身體半側麻木、走路像踩在棉花上的不穩，都該盡快就醫；急性期常需類固醇等治療，長期則視亞型與活動度選擇藥物以延緩惡化。`
    },
    {
      id: 'ra',
      ...
      longDescHtml:
`類風濕性關節炎是自體免疫造成的滑膜炎，清晨僵硬與對稱性小關節腫痛最典型。未控制的慢性發炎會像「火」一樣在關節內燒，時間拉長便侵蝕軟骨與骨端，導致關節變形、力量流失；發炎介質也可波及全身，引發貧血、疲倦與心血管風險上升。嚴重時，抓握開瓶、轉門把、扣鈕扣都成挑戰，甚至夜間痛醒。治療目標是「及早緩解發炎、阻止結構破壞」：以 csDMARDs、生物製劑或標靶小分子搭配密切追蹤調整劑量。拖延治療會讓不可逆的結構損傷悄悄累積，因此一旦出現持續多關節腫痛、晨僵超過 30 分鐘，需及時就醫由風濕專科介入。`
    },
    {
      id: 'sle',
      ...
      shortDesc: '多系統自體免疫病，可能侵犯腎、肺、心臟與中樞神經。',
      longDescHtml:
`紅斑性狼瘡是多系統自體免疫病，從皮疹、關節痛、畏光到腎臟炎、血液學異常、神經精神症狀皆可能出現。病勢活化時，免疫複合體如同細小砂粒沉積於器官，掀起一波波發炎：腎臟蛋白尿與腎功能惡化、胸痛與呼吸困難、劇烈頭痛或癲癇、口鼻潰瘍與高燒。若合併狼瘡腎炎且未及時治療，可能走向腎衰竭。治療依嚴重度使用類固醇、免疫調節/抑制劑與生物製劑，並需防曬與感染風險管理。任何不明原因的發燒、皮疹合併關節痛，或尿液泡泡多、下肢水腫等腎臟警訊，都應立即評估。`
    },
    {
      id: 'mg',
      ...
      longDescHtml:
`重症肌無力的核心是「使用越多越無力」：從眼瞼下垂、複視，到說話含糊、咀嚼吞嚥困難、頸部與近端四肢無力。病程波動，午後或活動後惡化更明顯；嚴重時呼吸肌受累，可能出現「肌無力危象」，呼吸衰竭需要加護治療。常見治療包括乙醯膽鹼酯酶抑制劑、免疫治療（類固醇、免疫抑制劑、生物製劑）與胸腺手術（特定族群）。若發現喝水易嗆、講話越講越小聲、抬頭困難，或合併呼吸急促與發紺，屬立即就醫指標。`
    },
    {
      id: 'cd',
      ...
      longDescHtml:
`屬於發炎性腸病（IBD）的一型，可影響從口腔到肛門的任何腸段、且呈跳躍分佈，腸壁全層發炎導致狹窄、瘻管與膿瘍。臨床上，陣發性腹痛、慢性腹瀉、體重下降、發燒與肛周病灶常反覆出現；重症時因狹窄引發腸阻塞，疼痛如絞、腹部脹如鼓，甚至嘔吐膽汁樣液體。長期發炎與營養不良會拖垮體力與生活品質。治療依嚴重度與部位採用生物製劑、免疫調節劑、短期類固醇與營養治療；併發狹窄或瘻管時可能需要外科處置。若大便帶血、持續腹瀉與體重快速下降，應盡速就醫。`
    },
    {
      id: 'uc',
      ...
      longDescHtml:
`潰瘍性結腸炎屬於發炎性腸道疾病的一種，主要累及大腸直腸黏膜，連續性發炎造成潰瘍、血便與腹痛。嚴重發作時，患者可能每天跑廁所十多次，解出帶血黏液、腹部絞痛不止，夜間也被迫起身；若發展為毒性巨結腸，腹脹加劇、發燒、脈搏快、白血球升高，需緊急處置以免穿孔與敗血。長期反覆發炎亦提高大腸癌風險。治療目標是誘導與維持緩解，常用 5-ASA、類固醇（短期）、免疫調節劑與多種生物製劑/小分子，必要時手術。出現血便、里急後重與體重下降時，及早就醫可降低併發症。`
    },
    {
      id: 'meniere',
      ...
      shortDesc: '內耳疾患；眩暈、耳鳴與波動性聽力損失。',
      longDescHtml:
`為內耳疾患，特徵是反覆且難以預測的眩暈發作，伴隨耳鳴、聽力波動與耳內悶脹感。發作來臨時，世界像被猛烈旋轉，患者需緊抓固定物、噁心嘔吐、步履蹣跚；每次可持續數分鐘到 24 小時，次數不定，長期可能導致進行性聽力損失與生活/工作中斷。治療著重減少發作頻率與控制症狀（如飲食限鹽、利尿劑、前庭復健、必要時侵入性治療）。若眩暈合併新出現的單側耳聾、神經學異常或持續不止，需排除其他急症。`
    },
    {
      id: 'pots',
      ...
      shortDesc: '站立時心跳顯著上升的自主神經失調。',
      longDescHtml:
`姿勢性心搏過速症候群的核心是「一站起來心跳飆快」：從坐/臥位起身後，短時間內心率明顯上升，常伴頭暈、眼前發黑、心悸、胸悶與疲憊，嚴重時接近暈厥。部分患者在感染、手術或壓力後發病，也與自主神經調節失衡、關節過度鬆弛等相關。病程可長期反覆，對學習與工作衝擊大。治療以非藥物為先（補水補鹽、分段起身、壓力襪、體能復健），必要時加入藥物（依個案）。若站立就心悸胸悶、伴意識模糊或跌倒風險，應就醫評估。`
    },
    {
      id: 'sarcoid',
      ...
      shortDesc: '多系統肉芽腫病變；可侵犯心臟或神經。',
      longDescHtml:
`此病以全身性肉芽腫為特徵，最常影響肺與淋巴結，也可波及皮膚、眼睛、心臟與神經。多數人無症狀或僅有咳嗽、喘與倦怠，但某些人會出現胸痛、呼吸困難、夜汗與體重下降。若心臟受累，可能導致心律不整、暈厥甚至猝死；神經系統受累則出現顏面神經麻痺或其他神經缺損。影像與組織學診斷後，依受累器官與嚴重度決定觀察或治療（如類固醇與免疫抑制劑）。持續乾咳、活動後喘、視力模糊或胸悶，應儘速評估。`
    },
    {
      id: 'as',
      ...
      shortDesc: '脊柱與薦髂關節發炎的慢性病。',
      longDescHtml:
`僵直性脊椎炎以軸向骨骼（脊柱、薦髂關節）發炎為主，反覆的炎症會讓下背在清晨最僵最痛，活動後才稍緩。若長期未控制，關節可能鈣化「橋接」，脊柱逐漸失去彈性，姿勢前屈、轉頭困難，一趟公車顛簸就能引發撕裂般的痛。部分患者還有葡萄膜炎（眼紅、畏光）、腸道症狀與心肺併發症。治療包括 NSAIDs、TNF/IL-17 抑制劑與復健運動，越早介入越能保留活動度。若年輕到中年反覆下背痛、晨僵>30 分鐘且活動可緩解，應懷疑並就醫。`
    },
    {
      id: 'ipf',
      ...
      shortDesc: '進行性間質性肺病與缺氧。',
      longDescHtml:
`特發性肺纖維化是進行性間質性肺病，肺泡壁反覆微傷後被纖維化取代，像把柔軟海綿慢慢變成硬化的疤痕網。病人會逐漸出現活動後呼吸喘、乾咳、杵狀指，後期即使走幾步也氣促，夜裡必須依賴氧氣。急性惡化（AE-IPF）時，數日內喘到說不出話、需住院高濃度氧氣甚至呼吸器。雖無法逆轉疤痕，但抗纖維化藥物可延緩惡化，並配合肺復健、氧療與移植評估。任何不明原因的漸進性喘與乾咳，都值得做肺功能與高解析電腦斷層檢查。`
    },
    {
      id: 'ssc',
      ...
      shortDesc: '結締組織過度纖維化，可能累及多器官。',
      longDescHtml:
`此病使皮膚與內臟結締組織過度纖維化，手指遇冷變白變紫（雷諾氏現象）、手指腫脹緊繃，臉部皮膚緊縮難以做表情；消化道蠕動變差導致胃食道逆流、吞嚥困難；肺動脈高壓或間質肺病會帶來進行性喘，嚴重者心、腎也會受累。對患者而言，每個清晨像穿上愈來愈緊的盔甲，連握筆和系鞋帶都疼痛吃力。治療著重器官監測與對症控制（血管擴張、免疫調節、抗纖維化/抗發炎策略），及早辨識肺與心血管受累能改善預後。`
    },
    {
      id: 'phpt',
      ...
      shortDesc: 'PTH 過多造成高鈣與骨質流失。',
      longDescHtml:
`由副甲狀腺過度分泌 PTH 引起高鈣血症，出現「骨痛、腎石、腹痛、精神症狀」等經典表現：反覆腎結石、骨質流失與骨折風險上升、噁心便祕、注意力不集中與情緒波動。嚴重高鈣時會嗜睡、脫水、心律異常，甚至意識改變。多數是單顆腺瘤所致，診斷靠血鈣、PTH 與腎功能/骨密評估；治療包括手術切除病變腺體與藥物/骨骼保護策略。若反覆腎結石或無明顯原因的高鈣，應排除此症。`
    },
    {
      id: 'pbc',
      ...
      shortDesc: '肝內小膽管自體免疫破壞導致膽汁滯留。',
      longDescHtml:
`原發性膽汁性膽管炎為自體免疫攻擊肝內小膽管，膽汁排出受阻，長年下來引發膽汁滯留性肝病與纖維化。初期常是難以忽視的「疲倦」與「瘋狂搔癢」—夜深人靜時越抓越睡不著；後期可見黃疸、脂溶性維生素缺乏、皮膚色素改變，嚴重者進展至肝硬化與門脈高壓。治療以 ursodeoxycholic acid 為基礎，對反應不佳者可加第二線藥物與併發症管理。長期追蹤肝功能與骨質密度十分重要。`
    },
    {
      id: 'pe',
      ...
      shortDesc: '血栓阻塞肺動脈的急症。',
      longDescHtml:
`肺栓塞是血栓堵住肺動脈分支所致，表現從不明原因的氣促、胸痛（吸氣加劇）、心跳快，到咳血、暈厥；巨大栓塞可迅速導致休克與猝死。典型急性場景：剛長途飛行或術後臥床，突然胸口像被重物壓住，一吸氣就刺痛、喘到說不出整句話。診斷倚賴臨床評估、D-dimer、影像與風險分層；治療以抗凝為主，危重時採溶栓或介入。任何「突發胸痛＋喘＋心跳快」都不應拖延。`
    },
    {
      id: 'pericarditis',
      ...
      shortDesc: '心包發炎引起胸痛。',
      longDescHtml:
`為心臟外層心包的發炎，胸痛常為尖銳刺痛、坐起前傾可減輕、平躺或吸氣加重；可能合併發燒、心悸與心包積液。若積液迅速累積形成心包填塞，病人會出現血壓下降、頸靜脈怒張、心音變弱等危象，需緊急處置。常見病因為病毒感染，但也可見於自體免疫或術後。診斷依心電圖、心肌酵素、超音波與炎症指標；治療以 NSAIDs/秋水仙素為要，重症或復發需進一步策略。`
    },
    {
      id: 'myocarditis',
      ...
      longDescHtml:
`心肌炎是心肌的發炎，從無症狀到劇烈胸痛、心律不整、心衰竭皆可能。部分患者在上呼吸道感染後數日到數週出現胸悶、喘與異常疲倦；嚴重時進展快速，如同心臟被「熄火」，需要強心、機械循環輔助甚至移植。診斷結合心電圖、心肌酵素、心臟超音波、心臟 MRI，必要時心內膜活檢。治療包括對症與支持（含心衰藥物、節律控制），特定病因再加免疫或抗病毒策略。胸痛伴發燒或心悸、暈厥，不可掉以輕心。`
    },
    {
      id: 'addison',
      ...
      longDescHtml:
`為腎上腺皮質功能低下，皮質醇與醛固酮不足導致極度疲倦、體重下降、食慾差、低血壓與鹽分渴求；皮膚與黏膜可能出現色素沉著。最危險的是「腎上腺危象」：劇烈嘔吐、腹痛、低血壓、電解質紊亂與休克，需立即補液與類固醇救命。長期治療仰賴荷爾蒙替代並學會「壓力劑量」調整。若反覆暈眩、站起就黑朦、持續疲憊合併色素加深，應盡速檢查。`
    },
    {
      id: 'pa',
      ...
      longDescHtml:
`乃是自體免疫破壞胃壁的內在因子，導致維生素 B12 無法吸收，紅血球生成受阻。病人除了貧血引起的蒼白、心悸、氣促與頭暈，還可能出現舌炎、四肢麻木、步態不穩與認知變化（B12 缺乏的神經影響）。若長期未治療，神經症狀可能不可逆。診斷結合 B12、抗內在因子抗體與血液學檢查；治療以 B12 注射/補充，並追蹤潛在胃部病變風險。`
    },
    {
      id: 'vm',
      ...
      longDescHtml:
`這類偏頭痛以眩暈與平衡障礙為主，可在頭痛前、頭痛時或完全沒有頭痛的情況下出現。發作時環境旋轉、步伐虛浮、光聲刺激加劇不適，患者難以行走與工作，甚至嘔吐脫水。誘因包括睡眠不足、壓力、特定食物與荷爾蒙波動。診斷重點在排除其他中樞或內耳病因；治療含發作期止暈止吐與預防性藥物（依個體選擇），再配合前庭復健與誘因管理。若眩暈伴神經學異常（單側無力、語言困難）應急診排除中風。`
    },
  ], []);
